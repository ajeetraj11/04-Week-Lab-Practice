...
public class ResumeScreeningMain {
    public static void main(String[] args) {
	   ...
	   Resume<SoftwareEngineer> resume1 = ResumeScreeningSystem.processResume("Ajeet", softwareEngineer);
	   Resume<DataScientist> resume2 = ResumeScreeningSystem.processResume("Amit", dataScientist);
	   Resume<ProductManager> resume3 = ResumeScreeningSystem.processResume("Abhishek", productManager);
