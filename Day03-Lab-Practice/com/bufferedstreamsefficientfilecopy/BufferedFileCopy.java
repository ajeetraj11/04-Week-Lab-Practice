...
public class BufferedFileCopy {
    ...
    public static void copyFileWithBuffer(String sourceFilePath, String destinationFilePath) {
        ...
        // Declare BufferedInputStream to read from the source file
        BufferedInputStream bufferedInputStream = null;

        // Declare BufferedOutputStream to write into the destination file
        BufferedOutputStream bufferedOutputStream = null;

        // Define the buffer size as 4 KB (4096 bytes)
