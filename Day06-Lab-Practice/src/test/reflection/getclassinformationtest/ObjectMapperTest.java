...
class ObjectMapperTest {
    ...
    void testToObjectMapping() {
        ...
        Map<String, Object> properties = Map.of("name", "Ajeet Raj", "age", 23);
        ...
        try {
            ...
            assertEquals("Ajeet Raj", nameField.get(user), "Name should be correctly mapped");
            assertEquals(23, ageField.get(user), "Age should be correctly mapped");
